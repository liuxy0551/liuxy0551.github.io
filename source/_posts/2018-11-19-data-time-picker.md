...
![](https://liuxy0551.gitee.io/image-hosting/posts/data-time-picker/1.gif)
...
![](https://liuxy0551.gitee.io/image-hosting/posts/data-time-picker/5.png)
```
    <!--出生日期的picker-->
...
![](https://liuxy0551.gitee.io/image-hosting/posts/data-time-picker/6.png)
```
    // 打开date-picker
    openPicker(picker) {
...
![](https://liuxy0551.gitee.io/image-hosting/posts/data-time-picker/2.gif)

#### 3、引入 Moment.js

　　随笔中的代码涉及了 Moment.js，这是一个用来格式化时间的 js 插件，比如下图的时间不便于前端使用，则可以通过 Moment.js 将其转化为 `2018-11-19` 等格式的时间。

![](https://liuxy0551.gitee.io/image-hosting/posts/data-time-picker/7.png)
