...
　　![](https://liuxy0551.gitee.io/image-hosting/posts/data-father-child/2.png)

　　上图，这边实现的是从父组件向子组件动态传值，传的是一个对象。在子组件上动态绑定要传入的对象，如果是静态数据（如："Hello World!"）则无需属性名前的冒号，并且需要在 components 中声明。

　　![](https://liuxy0551.gitee.io/image-hosting/posts/data-father-child/3.png)

　　上图，首先创建 props ，然后在 props 中创建对应的属性名，之后即可在 template 中使用接收到的对象。

　　![](https://liuxy0551.gitee.io/image-hosting/posts/data-father-child/4.png)
...
　　![](https://liuxy0551.gitee.io/image-hosting/posts/data-father-child/5.png)
...
　　然后在方法中添加以下代码：
    ...
    ```
　　![](https://liuxy0551.gitee.io/image-hosting/posts/data-father-child/6.png)
