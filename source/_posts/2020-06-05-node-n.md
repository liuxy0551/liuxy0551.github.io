...
![](https://liuxy0551.gitee.io/assets/posts/node-n/1.gif)

&emsp;&emsp;[node 以往的版本](https://nodejs.org/zh-cn/download/releases/)

### 一、管理工具 —— n

&emsp;&emsp;通过 npm 安装`n`：
```shell
npm i -g n
n -V
```
...
![](https://liuxy0551.gitee.io/assets/posts/node-n/2.png)
...
![](https://liuxy0551.gitee.io/assets/posts/node-n/3.png)
...
<a href="https://blog.csdn.net/wmzy1067111110/article/details/52963856" target="_black">linux 下使用"n"配置使用淘宝镜像</a>
<a href="https://mp.weixin.qq.com/s/C1g5FTjbT8pjG4iggiXVlw" target="_black">更换node版本切换工具n模块的镜像源</a>
