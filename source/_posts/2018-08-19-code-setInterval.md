...
![](https://liuxy0551.gitee.io/assets/posts/code-setInterval/1.gif)
...
![](https://liuxy0551.gitee.io/assets/posts/code-setInterval/2.png)
```
    <li>
      <div>
        <span>手机号</span>
...
![](https://liuxy0551.gitee.io/assets/posts/code-setInterval/3.png)
...
![](https://liuxy0551.gitee.io/assets/posts/code-setInterval/4.png)
```
  // 获取验证码
  getInforcode() {
    if(!this.ustelphone){
...
![](https://liuxy0551.gitee.io/assets/posts/code-setInterval/5.png)
```
.m-get-code{
