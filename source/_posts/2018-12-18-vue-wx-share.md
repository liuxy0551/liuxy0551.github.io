...
![](http://media.liuxianyu.cn/vue-wx-jssdk-3.png)
...
![](http://media.liuxianyu.cn/vue-wx-jssdk-4.png)
![](http://media.liuxianyu.cn/vue-wx-jssdk-5.png)

　　3、像下图这种基本就是没有完成页面的签名及授权验证，按照微信文档接收后端同学返回的数据即可。

![](http://media.liuxianyu.cn/vue-wx-jssdk-1.png)
```
  wxRegister(link) {
    let params = {
      url: link,
...
![](http://media.liuxianyu.cn/vue-wx-jssdk-7.png)
