...
![](https://liuxy0551.gitee.io/assets/posts/vue-wx-share/3.png)
...
![](https://liuxy0551.gitee.io/assets/posts/vue-wx-share/4.png)
![](https://liuxy0551.gitee.io/assets/posts/vue-wx-share/5.png)

　　3、像下图这种基本就是没有完成页面的签名及授权验证，按照微信文档接收后端同学返回的数据即可。

![](https://liuxy0551.gitee.io/assets/posts/vue-wx-share/1.png)
```
  wxRegister(link) {
    let params = {
      url: link,
...
![](https://liuxy0551.gitee.io/assets/posts/vue-wx-share/7.png)
