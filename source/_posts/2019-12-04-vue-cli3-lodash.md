...
&ensp;&ensp;&ensp;&ensp;`前端项目优化之旅`系列随笔主要记录工作中遇到的一些优化方案，这里记录一下在 Vue CLI 3 项目中单独引用 Lodash 函数。
...
``` javascript
  ...
  // => [['a', 'b'], ['c', 'd']]
```
![](https://liuxy0551.gitee.io/assets/posts/vue-cli3-lodash/1.png)
...
``` javascript
  ...
  // => [['a', 'b'], ['c', 'd']]
```
![](https://liuxy0551.gitee.io/assets/posts/vue-cli3-lodash/2.png)
