...
&emsp;&emsp;mysql 5.7 的安装可参考 <a href="https://liuxianyu.cn/article/docker-c.html" target="_black">前端学习 Docker 之旅（四）—— 下载 mysql 镜像并启动、连接，修改时区</a>。
...
```
docker stop docker-mysql-5.7
docker start docker-mysql-5.7
```
