...
　　![](https://liuxy0551.gitee.io/image-hosting/posts/vue-wepy-filter/1.png)
    
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在后端同学没有返回适合显示的数据或者不方便处理数据时，可以在前端使用过滤器处理，上述对时间和金额进行处理，使用 `|` 作为管道符，传递参数进行序列化。date 的过滤写法可参考 [date.js](https://github.com/liuxy0551/liuxy0551.github.io/blob/master/assets/posts/vue-wepy-filter/date.js) 。
   

### 二、小程序中过滤器的使用

　　![](https://liuxy0551.gitee.io/image-hosting/posts/vue-wepy-filter/2.png)

　　![](https://liuxy0551.gitee.io/image-hosting/posts/vue-wepy-filter/3.png)
...
　　![](https://liuxy0551.gitee.io/image-hosting/posts/vue-wepy-filter/4.png)
