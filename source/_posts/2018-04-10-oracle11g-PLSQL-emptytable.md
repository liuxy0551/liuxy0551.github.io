...
![](https://liuxy0551.gitee.io/image-hosting/posts/oracle11g-PLSQL-emptytable/1.png)<br>

可以通过语句导出查询结果，执行导出的语句即可（表数量少的话可以复制粘贴执行查询结果）。

<br>![](https://liuxy0551.gitee.io/image-hosting/posts/oracle11g-PLSQL-emptytable/2.png)
