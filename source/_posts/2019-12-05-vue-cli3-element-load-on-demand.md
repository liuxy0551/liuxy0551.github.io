...
&ensp;&ensp;&ensp;&ensp;`前端项目优化之旅`系列随笔主要记录工作中遇到的一些优化方案，这里记录一下 Vue CLI 3 项目中如何让 Element 按需引入组件。
...
Vue.use(ElementUI)
```
![](https://liuxy0551.gitee.io/assets/posts/vue-cli3-element-load-on-demand/1.png)
...
```
![](https://liuxy0551.gitee.io/assets/posts/vue-cli3-element-load-on-demand/2.png)
