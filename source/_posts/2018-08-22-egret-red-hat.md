...
　　![](https://liuxy0551.gitee.io/image-hosting/posts/egret-red-hat/5.png)
...
　　![](https://liuxy0551.gitee.io/image-hosting/posts/egret-red-hat/6.png)
...
　　![](https://liuxy0551.gitee.io/image-hosting/posts/egret-red-hat/8.png)
...
　　![](https://liuxy0551.gitee.io/image-hosting/posts/egret-red-hat/9.png)

　　可以对照我放在 [Github](https://github.com/liuxy0551/RedHat) 上的源码，每个新建的 EUI 组件全部采用单例模式编写，利于后期调用被其他组件调用该组件中的方法。下图中的红框即是快速布局功能区。

　　![](https://liuxy0551.gitee.io/image-hosting/posts/egret-red-hat/10.png)
